...
/obj/effect/proc_holder/spell/terror_stealth
	...
	clothes_req = FALSE
	human_req = FALSE
	sound = 'modular_ss220/terror_spiders/sound/stealth.ogg'
...
/obj/effect/proc_holder/spell/terror_stealth/proc/reveal(mob/user)
	...
	playsound(user.loc, 'modular_ss220/terror_spiders/sound/stealth_out.ogg', 150, TRUE)
...
/obj/effect/proc_holder/spell/aoe/terror_healing
	...
	human_req = FALSE
	aoe_range = 6
	sound = 'modular_ss220/terror_spiders/sound/heal.ogg'
	var/heal_amount = 20
...
/obj/effect/proc_holder/spell/fireball/venom_spit
	...
	sound = 'modular_ss220/terror_spiders/sound/spit2.ogg'
...
/obj/effect/proc_holder/spell/emplosion/terror_emp
	...
	clothes_req = FALSE
	human_req = FALSE
	sound = 'modular_ss220/terror_spiders/sound/brown_shriek.ogg'
	emp_heavy = 3
	emp_light = 2
...
/obj/effect/proc_holder/spell/aoe/conjure/build/terror_shield
	...
	human_req = FALSE
	delay = 0 SECONDS
	cast_sound = 'modular_ss220/terror_spiders/sound/mod_defence.ogg'
	summon_type = list(/obj/effect/forcefield/terror) //закладка
...
/obj/effect/proc_holder/spell/terror_smoke
	...
	clothes_req = FALSE
	human_req = FALSE
	sound = 'modular_ss220/terror_spiders/sound/attack2.ogg'
...
/obj/effect/proc_holder/spell/aoe/terror_shriek
	...
	human_req = FALSE
	aoe_range = 7
	sound = 'modular_ss220/terror_spiders/sound/white_shriek.ogg'
...
/obj/effect/proc_holder/spell/aoe/terror_shriek_princess
	...
	human_req = FALSE
	aoe_range = 6
	sound = 'modular_ss220/terror_spiders/sound/princess_shriek.ogg'
...
/obj/effect/proc_holder/spell/aoe/terror_slam
	...
	human_req = FALSE
	aoe_range = 2
	sound = 'modular_ss220/terror_spiders/sound/prince_attack.ogg'
...
/obj/effect/proc_holder/spell/aoe/conjure/build/terror_jelly
	...
	human_req = FALSE
	delay = 3.3 SECONDS
	cast_sound = 'modular_ss220/terror_spiders/sound/jelly.ogg'
...
/obj/effect/proc_holder/spell/aoe/terror_shriek_queen
	...
	human_req = FALSE
	aoe_range = 7
	sound = 'modular_ss220/terror_spiders/sound/queen_shriek.ogg'
