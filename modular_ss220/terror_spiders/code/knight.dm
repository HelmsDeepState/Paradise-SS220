...
/mob/living/simple_animal/hostile/poison/terror_spider/knight
	...
	attack_sound = 'modular_ss220/terror_spiders/sound/terrorspiders/bite2.ogg'
	death_sound = 'modular_ss220/terror_spiders/sound/terrorspiders/death1.ogg'
...
/mob/living/simple_animal/hostile/poison/terror_spider/knight/proc/activate_mode(n)
	var/t = world.time
	if	(n==0)
		playsound(src, 'modular_ss220/terror_spiders/sound/keratosis_out.ogg', 150)
	...
	if	(n==1)
		if(attack_mode_av)
			...
			last_mode = t
			attack_mode_av = 0
			playsound(src, 'modular_ss220/terror_spiders/sound/mod_attack.ogg', 120)
	...
	if	(n==2)
		if(defence_mode_av)
			...
			last_mode = t
			defence_mode_av = 0
			playsound(src, 'modular_ss220/terror_spiders/sound/keratosis_in.ogg', 150)
