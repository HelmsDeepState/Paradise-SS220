...
/mob/living/simple_animal/hostile/poison/terror_spider/queen
	...
	death_sound = 'modular_ss220/terror_spiders/sound/queen_death.ogg'
	...
	retreat_distance = 5
	minimum_distance = 5
	projectilesound = 'modular_ss220/terror_spiders/sound/spit2.ogg'
...
/mob/living/simple_animal/hostile/poison/terror_spider/queen/proc/DoQueenScreech(light_range, light_chance, camera_range, camera_chance)
	...
	playsound(src.loc, 'modular_ss220/terror_spiders/sound/queen_shriek.ogg', 100, 1)
